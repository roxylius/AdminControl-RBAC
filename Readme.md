...
### 1. Users Management
This component allows admin to view, add, edit, or remove users.  
<img width="640" alt="users" src="https://github.com/user-attachments/assets/ae2d73ee-e1fa-4320-9d11-e3b2b26bca90">

---

### 2. Roles Management
Define and manage roles with varying permissions to ensure proper access control.  
Also allows to view, add, edit, or remove roles.
...
Admin can assign or revoke permissions.  
Also allows to view, add, edit, or remove roles.
...
### 5. Activity Log
View logs to track user actions and maintain system accountability.  
<img width="640" alt="log" src="https://github.com/user-attachments/assets/fe0a1579-8492-47eb-a6b8-ccb11ee0239d">

---

### 6. Dashboard Overview
Provides a summary of the system's current state, including user and role statistics.  
