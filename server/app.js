...
//set up middleware
app.use(cors({ origin: ['http://localhost:3000', 'http://localhost:3001', 'http://localhost:4444', 'exp://192.168.239.205:19000', 'http://localhost:7501'], credentials: true, methods: ['GET', 'POST', 'DELETE','PUT'] })); //to enable cross origin resourse sharing ie make post,get,etc request form different url
